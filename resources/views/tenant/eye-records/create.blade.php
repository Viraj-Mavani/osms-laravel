...
<div class="p-4 p-md-5" style="max-width:72rem;">
    ...
    <div class="mb-4">
        ...
        <p class="text-muted-foreground mb-0" style="font-size:.9rem;">
            Complete refractive examination for <span class="fw-medium">{{ $patient->name }}</span>
        </p>
    </div>
    ...
    <form method="POST" action="{{ route('tenant.eye-records.store', $patient) }}" class="d-flex flex-column gap-4">
                    ...
                    <table class="table align-middle mb-0" style="font-size:.9rem;">
                        ...
                        <tbody>
                            ...
                            <tr class="eye-record-row">
                                ...
                                <td class="text-center"><input type="number" name="od_sph" step="0.25" value="{{ old('od_sph') }}" class="form-control form-control-sm text-center @error('od_sph') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center"><input type="number" name="od_cyl" step="0.25" value="{{ old('od_cyl') }}" class="form-control form-control-sm text-center @error('od_cyl') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center"><input type="number" name="od_axis" min="0" max="180" step="1" value="{{ old('od_axis') }}" class="form-control form-control-sm text-center @error('od_axis') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center pe-3"><input type="text" name="od_va" value="{{ old('od_va') }}" class="form-control form-control-sm text-center @error('od_va') is-invalid @enderror" placeholder="6/6"></td>
                                <td class="text-center ps-3 border-start"><input type="number" name="os_sph" step="0.25" value="{{ old('os_sph') }}" class="form-control form-control-sm text-center @error('os_sph') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center"><input type="number" name="os_cyl" step="0.25" value="{{ old('os_cyl') }}" class="form-control form-control-sm text-center @error('os_cyl') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center"><input type="number" name="os_axis" min="0" max="180" step="1" value="{{ old('os_axis') }}" class="form-control form-control-sm text-center @error('os_axis') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center pe-4"><input type="text" name="os_va" value="{{ old('os_va') }}" class="form-control form-control-sm text-center @error('os_va') is-invalid @enderror" placeholder="6/6"></td>
                            ...
                            <tr class="eye-record-row">
                                ...
                                <td class="text-center"><input type="number" name="od_nv" step="0.25" value="{{ old('od_nv') }}" class="form-control form-control-sm text-center @error('od_nv') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center" colspan="3"></td>
                                <td class="text-center ps-3 border-start"><input type="number" name="os_nv" step="0.25" value="{{ old('os_nv') }}" class="form-control form-control-sm text-center @error('os_nv') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center" colspan="3"></td>
                            ...
                            <tr class="eye-record-row">
                                ...
                                <td class="text-center"><input type="number" name="od_add" step="0.25" value="{{ old('od_add') }}" class="form-control form-control-sm text-center @error('od_add') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center" colspan="3"></td>
                                <td class="text-center ps-3 border-start"><input type="number" name="os_add" step="0.25" value="{{ old('os_add') }}" class="form-control form-control-sm text-center @error('os_add') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center" colspan="3"></td>
                            ...
                            <tr class="eye-record-row">
                                ...
                                <td class="text-center"><input type="number" name="od_spl" step="0.25" value="{{ old('od_spl') }}" class="form-control form-control-sm text-center @error('od_spl') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center" colspan="3"></td>
                                <td class="text-center ps-3 border-start"><input type="number" name="os_spl" step="0.25" value="{{ old('os_spl') }}" class="form-control form-control-sm text-center @error('os_spl') is-invalid @enderror" placeholder="—"></td>
                                <td class="text-center" colspan="3"></td>
        ...
        <div class="row g-3">
            ...
            <div class="col-sm-9">
                ...
                <textarea id="notes" name="notes" rows="2" class="form-control" placeholder="Remarks, special observations, follow-up notes…">{{ old('notes') }}</textarea>
            </div>
        </div>
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-2"></i>Save prescription</button>
        </div>
    </form>
</div>
